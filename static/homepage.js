...
$(function() {
  ...
  $("#end_location").geocomplete();
    ...
    $("#end_location").bind("geocode: result", function(event, result){
      $.log("Result: "+ result.formatted_address);
    })
    $("#end_location").bind("geocode:error", function(event, status){
      $.log("ERROR: "+ status);
    })
    $("#end_location").bind("geocode:multiple", function(event, results){
